...
void main() {
  runApp(PregnancyPreparation());
}

class PregnancyPreparation extends StatelessWidget {
  @override
        ...
        children: [
          ...
          Positioned(
            ...
            child: SingleChildScrollView(
              child: Text(
                'Preparing for labor and delivery involves understanding the birth process, creating a birth plan, and packing a hospital bag with essentials. First-time moms often need extra support and information to navigate this exciting and overwhelming journey.',
                style: TextStyle(
                  fontSize: 12.5,
                  color: Colors.black,
                ),
