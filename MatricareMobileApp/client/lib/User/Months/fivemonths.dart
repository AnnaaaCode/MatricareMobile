...
class Fivemonths extends StatefulWidget {
  @override
  _Week5State createState() => _Week5State();
}

class _Week5State extends State<Fivemonths> {
          ...
          children: [
            Positioned.fill(
              child: CarouselSlider(
                ...
                items: [
                  _buildCarouselItem('images/months/fivemonths1.jpg'),
                  _buildCarouselItem('images/months/fivemonths2.jpg'),
                  _buildCarouselItem('images/months/fivemonths3.jpg'),
                ],
              ),
            ),
           Positioned(
