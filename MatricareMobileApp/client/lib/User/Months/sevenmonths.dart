...
class Sevenmonths extends StatefulWidget {
  @override
  _Week7State createState() => _Week7State();
}

class _Week7State extends State<Sevenmonths> {
          ...
          children: [
            Positioned.fill(
              child: CarouselSlider(
                ...
                items: [
                  _buildCarouselItem('images/months/sevenmonths1.jpg'),
                  _buildCarouselItem('images/months/sevenmonths2.jpg'),
                  _buildCarouselItem('images/months/sevenmonths3.jpg'),
                ],
              ),
            ),
           Positioned(
