...
class Threemonths extends StatefulWidget {
  @override
  _Week3State createState() => _Week3State();
}

class _Week3State extends State<Threemonths> {
          ...
          children: [
            Positioned.fill(
              child: CarouselSlider(
                ...
                items: [
                  _buildCarouselItem('images/months/threemonths1.jpg'),
                  _buildCarouselItem('images/months/threemonths2.jpg'),
                  _buildCarouselItem('images/months/threemonths3.jpg'),
                ],
              ),
            ),
            Positioned(
