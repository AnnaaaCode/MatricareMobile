...
class Ninemonths extends StatefulWidget {
  @override
  _Week9State createState() => _Week9State();
}

class _Week9State extends State<Ninemonths> {
          ...
          children: [
            Positioned.fill(
              child: CarouselSlider(
                ...
                items: [
                  _buildCarouselItem('images/months/ninemonths1.jpg'),
                  _buildCarouselItem('images/months/ninemonths2.jpg'),
                  _buildCarouselItem('images/months/ninemonths3.jpg'),
                ],
              ),
            ),
            Positioned(
                ...
                child: BackdropFilter(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      color: Color(0xFF9a6cb4).withOpacity(0.7), // Purple background color with some transparency
