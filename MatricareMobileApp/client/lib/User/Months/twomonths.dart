...
class Twomonths extends StatefulWidget {
  @override
  _Week2State createState() => _Week2State();
}

class _Week2State extends State<Twomonths> {
          ...
          children: [
            Positioned.fill(
              child: CarouselSlider(
                ...
                items: [
                  _buildCarouselItem('images/months/twomonths1.jpg'),
                  _buildCarouselItem('images/months/twomonths2.jpg'),
                  _buildCarouselItem('images/months/twomonths3.jpg'),
                ],
              ),
            ),
            Positioned(
