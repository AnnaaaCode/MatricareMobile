...
class Fourmonths extends StatefulWidget {
  @override
  _Week4State createState() => _Week4State();
}

class _Week4State extends State<Fourmonths> {
          ...
          children: [
            Positioned.fill(
              child: CarouselSlider(
                ...
                items: [
                  _buildCarouselItem('images/months/fourmonths1.jpg'),
                  _buildCarouselItem('images/months/fourmonths2.jpg'),
                  _buildCarouselItem('images/months/fourmonths3.jpg'),
                ],
              ),
            ),
           Positioned(
