...
class Sixmonths extends StatefulWidget {
  @override
  _Week6State createState() => _Week6State();
}

class _Week6State extends State<Sixmonths> {
          ...
          children: [
            Positioned.fill(
              child: CarouselSlider(
                ...
                items: [
                  _buildCarouselItem('images/months/sixmonths1.jpg'),
                  _buildCarouselItem('images/months/sixmonths2.jpg'),
                  _buildCarouselItem('images/months/sixmonths3.jpg'),
                ],
              ),
            ),
            Positioned(
